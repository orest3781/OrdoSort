...
- [ ] Timing-flaky under check.bat load, 2026-09-24: `FolderWatchServiceTests.AFileLandingReachesTheDebounce`, `BulkRenameProbeTests.TypingABurstRunsThePlanOnceNotPerKeystroke` and `BulkRenameViewModelTests.TheRowSelectionSurvivesARebuiltPreview` all timed out at the same second (3 s waits); the rerun passed 1,700/1,700
