...
/// BulkRename, PageCounts, and the two zip windows — ZipTools (Zip and
/// unzip) and MergePdfs, each tracking the ONE grid it owns — take the
/// remainder rule; Triage supplies its own
